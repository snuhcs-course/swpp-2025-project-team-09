...
class TestUserRegisterViewIntegration(TestCase):
    """Integration tests for User Register endpoint"""
...
class TestUserLoginViewIntegration(TestCase):
...
class TestUserChangeLangViewIntegration(TestCase):
    """Integration tests for User Change Language endpoint"""
...
class TestUserInfoViewIntegration(TestCase):
    """Integration tests for User Info endpoint"""
