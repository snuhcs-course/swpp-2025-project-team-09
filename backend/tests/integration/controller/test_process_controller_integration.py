...
class TestProcessUploadViewIntegration(TestCase):
    """Integration tests for Process Upload endpoint"""
    ...
    def test_01_upload_success(self, mock_tts_class, mock_ocr_class):
        ...
        # Mock TTS result (async function)
    ...
    def test_04_upload_missing_image(self):
        ...
        data = {"session_id": str(self.test_session.id), "lang": "en"}
        response = self.client.post("/process/upload/", data, format="json")
    ...
    def test_06_upload_ocr_failure(self, mock_ocr_class):
        """Test upload when OCR finds no text (should still succeed with no_text result)"""
...
class TestCheckOCRStatusViewIntegration(TestCase):
    ...
    def test_02_check_ocr_missing_session_id(self):
        ...
        response = self.client.get("/process/check_ocr/", {"page_index": 0})
    ...
    def test_03_check_ocr_missing_page_index(self):
        ...
        response = self.client.get(
            "/process/check_ocr/", {"session_id": str(self.test_session.id)}
        )
...
class TestCheckTTSStatusViewIntegration(TestCase):
    """Integration tests for Check TTS Status endpoint"""
    ...
    def test_05_check_tts_missing_session_id(self):
        ...
        response = self.client.get("/process/check_tts/", {"page_index": 0})
    ...
    def test_06_check_tts_missing_page_index(self):
        ...
        response = self.client.get(
            "/process/check_tts/", {"session_id": str(self.test_session.id)}
        )
