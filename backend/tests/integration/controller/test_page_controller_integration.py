...
class TestPageGetImageViewIntegration(TestCase):
    """Integration tests for Page Get Image endpoint"""
...
class TestPageGetOCRViewIntegration(TestCase):
    """Integration tests for Page Get OCR endpoint"""
...
class TestPageGetTTSViewIntegration(TestCase):
    """Integration tests for Page Get TTS endpoint"""
